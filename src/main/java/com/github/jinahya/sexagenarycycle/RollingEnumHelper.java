...
final class RollingEnumHelper {
    ...
    // -----------------------------------------------------------------------------------------------------------------
    static <E extends Enum<E> & RollingEnum<E>> E getPrevious(final Class<E> clazz, final E current,
    ...
    // -----------------------------------------------------------------------------------------------------------------
    static <E extends Enum<E> & RollingEnum<E>> E getNext(final Class<E> clazz, final E current,
                                                          final Function<? super E, ? extends E> mapper) {
